...
export class includeRefreshTokenOnAuth1595472514323 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_d39749caee6b84266cc015329d" ON "user" ("refresh_token") WHERE "user"."refresh_token" IS NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "revoked_token" RENAME COLUMN "createdAt" TO "created_at"`);
        await queryRunner.query(`ALTER TABLE "revoked_token" RENAME COLUMN "updatedAt" TO "updated_at"`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "revoked_token" RENAME COLUMN "created_at" TO "createdAt"`);
        await queryRunner.query(`ALTER TABLE "revoked_token" RENAME COLUMN "updated_at" TO "updatedAt"`);
    }
